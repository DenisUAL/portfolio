...
injectGlobal`
  @import url('https://fonts.googleapis.com/css?family=Dancing+Script|Mukta+Malar|Playfair+Display|Roboto+Condensed');
  @import url('https://cdnjs.cloudflare.com/ajax/libs/materialize/0.100.2/css/materialize.min.css');
  @import url('https://cdnjs.cloudflare.com/ajax/libs/materialize/0.100.2/js/materialize.min.js');
